...
Module.register("compliments", {
	...
	defaults: {
		compliments: {
			anytime: ["Super puñoooo!!!"],
			morning: ["Buenos dias princesit@", "Gus mornis a todos", "¿Te has levantado sostenible hoy?", "Toca redes!!! Levantaaaa!!!"],
			afternoon: ["Pedro el movil!", "Ya has vuelto?", "Amo a comé"],
			evening: ["Chao bacalao", "Toca partyyy", "Una servesa porfa"],
			"....-01-01": ["Epaaaaaa una vueltecita más!"]
		},
